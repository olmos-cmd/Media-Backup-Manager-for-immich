...
| Deutsch | English |
|---|---|
| ![Dark Mode German albums](docs/screenshots/02-dark-german-albums.png) | ![Dark Mode English albums](docs/screenshots/01-dark-english-albums.png) |

### Dark Mode – Jahresansicht / Year view

| Deutsch | English |
|---|---|
| ![Dark Mode German year view](docs/screenshots/04-dark-german-years.png) | ![Dark Mode English year view](docs/screenshots/03-dark-english-years.png) |

### Light Mode / Light mode

| Deutsch | English |
|---|---|
| ![Light Mode German albums](docs/screenshots/05-light-german-albums.png) | ![Light Mode English albums](docs/screenshots/06-light-english-albums.png) |
