...
impl ImmichApp {
    ...
    fn draw_logo(&self, ui: &mut egui::Ui) {
        if let Some(texture) = &self.logo_texture {
            ui.add(egui::Image::new(texture).fit_to_exact_size(egui::vec2(360.0, 177.8)));
        }
    }

    fn draw_header_logo(&self, ui: &mut egui::Ui) {
        if let Some(texture) = &self.header_logo_texture {
            // Original-PNG unverändert verwenden und exakt im 3:2-Seitenverhältnis anzeigen.
            ui.add(
                egui::Image::new(texture)
                    .fit_to_exact_size(egui::vec2(307.2, 204.8)),
            );
        }
    }
        ...
        egui::Frame::none()
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    // Kompakter zweizeiliger Beschreibungstext direkt neben dem Logo.
                    ui.allocate_ui_with_layout(
                        egui::vec2(510.0, 195.0),
                    ...
                    // Bedienknöpfe mittig auf Höhe des Textblocks ausrichten.
                ...
                ui.add_space(4.0); ui.separator(); ui.add_space(8.0);
